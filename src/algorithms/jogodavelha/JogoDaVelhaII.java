	...
	public static void main(String[] args) {
		...
		while (!ganhou) {
			...
			if ((jogoVelha[0][0] == 'X' && jogoVelha[0][1] == 'X' && jogoVelha[0][2] == 'X')|| // linha 1
					...
					(jogoVelha[0][1] == 'X' && jogoVelha[1][0] == 'X' && jogoVelha[2][0] == 'X')|| // coluna 1
					(jogoVelha[0][2] == 'X' && jogoVelha[1][1] == 'X' && jogoVelha[2][1] == 'X')|| // coluna 2
					(jogoVelha[0][0] == 'X' && jogoVelha[1][2] == 'X' && jogoVelha[2][2] == 'X')|| // coluna 3
					(jogoVelha[0][2] == 'X' && jogoVelha[1][1] == 'X' && jogoVelha[2][2] == 'X')|| // diagonal
					(jogoVelha[0][2] == 'X' && jogoVelha[1][1] == 'X' && jogoVelha[2][2] == 'X')) { // diagonal
				ganhou = true;
